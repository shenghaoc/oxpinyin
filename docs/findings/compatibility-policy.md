...
below) · **REVERT TARGET** 5 (rows 32, 33, 34, 35, 36) ·
...
12 → 10 → 11 → 9 sequence. Residue E (the candidate window behind the
composition offset, `probe-coverage-abi.md` E) is diagnosed and not
registered; the maintainer rules. The `tuihui` dump stays as the band illustration (both
