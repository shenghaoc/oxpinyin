...
//! tests can take a model-dir path; it does not read frequencies, score, or
//! change what the decoder consumes.
...
/// Workspace root that contains `crates/pinyin-oracle` and the provenance finding.
