...
/// snapshot stream, a tkrzw hash file, the native container on redb
...
/// an in-memory stash (`ngram_kyotodb.cpp:82-101`) where tkrzw and redb
...
mod tests {
    ...
    fn the_bigram_round_trips_through_the_user_bigram_container() {
        ...
        // native container on redb. Opening it as a plain hash file
    ...
    /// on Kyoto Cabinet, tkrzw, redb and Berkeley DB (measured
    /// 2026-09-09).
