...
| Path | What |
|---|---|
| `crates/*` | 14 crates, none stubs (grouped below) |
...
| Group | Crates |
|---|---|
| Engine / data / runtime / bindings | `oxpinyin-core`, `oxpinyin-data`, `oxpinyin-user`, `oxpinyin-engine`, `oxpinyin-runtime`, `oxpinyin-capi`, `oxpinyin-python` |
