...
//! oxpinyin-datagen's, and oxpinyin-eval's discovery exactly; with the
//! `kyotocabinet` feature off it emits nothing. As in the store, the rpath
//! is a convenience, not the contract: an artifact built without it must
