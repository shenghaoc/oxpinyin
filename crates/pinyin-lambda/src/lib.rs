...
//!
//! It consumes W9-T2's integer [`pinyin_counter::Counts`] as the system
...
//! (`pinyin-data/src/lm.rs` `LAMBDA_NUMERATOR/LAMBDA_DENOMINATOR = 1/2`).
...
//! [`pinyin_counter`]); floating point (`parameter_t = double`) appears
