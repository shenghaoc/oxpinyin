...
| 2026-09-04 | (this) | runtime data (interpolation2.text) | 38.85 MiB (1.97 MiB interpolation2.text present) | 36.88 MiB (file removed) | strace confirmed the runtime never opens `interpolation2.text` post-P6. Datagen no longer emits it; saves 1.97 MiB. Runtime data ratio 1.09× → 1.04×, total install 1.07× → 1.03×. Init unchanged. See `docs/perf/perf-baseline-kc-2026-09.md`. |
