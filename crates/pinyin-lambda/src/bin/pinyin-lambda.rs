...
//!
//! Usage: pinyin-lambda [--deleted HELDOUT] [--export-dir DIR] SYSTEM
//!
...
use pinyin_counter::count_ngseg;
...
fn print_help() {
    print!(
        "Usage: pinyin-lambda [--deleted HELDOUT] [--export-dir DIR] [--skip-pi-gram-training] SYSTEM\n\
         \n\
         ...
         \n\
           ...
           --export-dir DIR    migrate export (phrase_index.redb) for the freq-1 floor\n\
