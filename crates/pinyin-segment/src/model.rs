...
//!
//! Bigrams come from [`pinyin_data::BigramLanguageModel`] (`bigram.redb`,
//! the verbatim export of the pin's `SYSTEM_BIGRAM`). Unigrams come from
//! [`pinyin_data::parse_interpolation2`] plus the `gen_unigram` freq-1 floor
...
use pinyin_data::{BigramLanguageModel, BigramRow, parse_interpolation2};
